...
![CloudTrail configuration](evidence/cloudtrail-multiregion-config.png)
...
![IAM Event History](evidence/iam-events-us-east-1.png)
...
![Denied EC2 Event](evidence/denied-ec2-event-us-east-2.png)
